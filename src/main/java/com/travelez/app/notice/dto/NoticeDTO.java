...
public class NoticeDTO implements Serializable {
	...
	public NoticeDTO(int seq, String id, int ref, int step, int depth, String title, String content, String wdate,
	...
	public String toString() {
		return "NoticeDTO [seq=" + seq + ", id=" + id + ", ref=" + ref + ", step=" + step + ", depth=" + depth
